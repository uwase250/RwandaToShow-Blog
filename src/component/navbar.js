...
const Navbar = () => {
  ...
  const handlesignup = async (data) => {
    try {
      const response = await fetch(
        "https://blog-6hj4.onrender.com/api/user/signup",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div>
        ...
        <div className="loginModal">
          ...
          <div className="form">
            ...
            <p>
              ...
              <Link onClick={handleModale}>Create Account</Link>
            </p>
      ...
      {modale && (
        <div className="loginModal">
          <button onClick={handleModale} className="close">
            <AiOutlineClose className="iconx" />
          </button>
          <div className="form">
            <h3>Create Account</h3>
            <p>
              Already Have Account<Link onClick={handleModale}> Login</Link>
            </p>
            <div className="inputController">
